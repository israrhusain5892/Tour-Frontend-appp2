...
const Adminmain = () => {
    ...
    return (
        <Admin>
            <div className="container  pl-12 pr-12 pb-12 pt-12 mx-auto p-4 bg-[#102C57] text-white">
                <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-16">
                    <div
                        className="bg-[#1E0342] p-6 rounded-lg shadow-custom-red border-double border-4 border-[#FFCBCB]  transition-transform transform hover:scale-105 cursor-pointer h-[600px] flex flex-col"
                    ...
                    >
                        <div className="flex-grow flex flex-col items-center justify-start">
                            {loading ? (
                                ...
                                <>
                                    <h1 className="text-2xl font-bold mt-4">Number of Trips (Statewise)</h1>
                    ...
                    <div className="bg-[#1E0342] p-6 rounded-lg shadow-custom-red border-double border-4 border-[#FFCBCB] transition-transform transform hover:scale-105 cursor-pointer h-[600px] flex flex-col">
