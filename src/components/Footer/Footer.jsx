    ...
    return (
        <footer className="bg-[#600180] py-4 md:py-8 lg:py-5 dark:bg-[#600180] z-999">
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                    <div className="flex flex-col items-start">
                        <a className="flex items-center" href="#">
                            ...
                            <span className="ml-2 text-lg font-bold text-gray-900 dark:text-gray-50">Inidan Traverse</span>
                        </a>
                    ...
                    <div className='py-8'>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center">
                                ...
                                <a className="ml-2 text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-50" href="#">
                                    info@indiantraverse.com
                                </a>
                            </div>
                            <div className="flex items-center">
                ...
                {/* <div className="text-gray-100  dark:text-gray-100 flex justify-center">2024 Indian Traverse</div> */}
            </div>
